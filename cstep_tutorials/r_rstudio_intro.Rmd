...
Major data types: `double`, `integer`, `complex`, `logical`, `character`, `factor` The sixth one`factor is variable which take on a limited number of different values. Factors usually look like character data, but are typically used to represent categorical information.
